...
Route::get('/edit-operation/{id}', [OperationCaisseController::class, 'edit_operation']);
Route::put('/update-operation/{id}', [OperationCaisseController::class, 'update_operation']);
